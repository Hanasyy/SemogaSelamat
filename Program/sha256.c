...
// Macros untuk operasi bit yang digunakan dalam algoritma SHA256
...
void sha256_final(SHA256_CTX *ctx, uint8_t hash[])
{
    ...
    // Simpan bitlen ke 8 byte terakhir dalam big endian:
    ...
    // Copy hasil hash ke array output hash (32 bytes)
